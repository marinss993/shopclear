...
<div class="js-stools clearfix jshop_block_filter">
    ...
    <div class="js-stools-container-filters">
        ...
        <div class="js-stools-field-filter">
            <label><?php print _JSHOP_DATE_FROM?>:</label>
            <div class="control"><?php echo JHTML::_('calendar', $this->filter['date_from'], 'date_from', 'date_from', $jshopConfig->field_birthday_format, array('class'=>'inputbox', 'size'=>'10', 'maxlength'=>'10'));?></div>
        </div>
		<div class="js-stools-field-filter">
            <label><?php print _JSHOP_DATE_TO?>:</label>
            <div class="control"><?php echo JHTML::_('calendar', $this->filter['date_to'], 'date_to', 'date_to', $jshopConfig->field_birthday_format, array('class'=>'inputbox', 'size'=>'10', 'maxlength'=>'10'));?></div>
        </div>
        <div class="js-stools-field-filter">
            <div class="control">
                <button class="btn hasTooltip" type="submit" title="<?php print _JSHOP_SEARCH?>">
 ...
 <thead>
   ...
   <tr class="row<?php echo ($i  %2);?>" <?php if (!$row->order_created) print "style='font-style:italic; color: #b00;'"?>>
     ...
     <?php if ($row->order_created && $display_info_order){?>
        ...
        <input class="button btn btn-small" type="button" name="" value="<?php echo _JSHOP_UPDATE_STATUS?>" onclick="verifyStatus(<?php echo $row->order_status; ?>, <?php echo $row->order_id; ?>, '<?php echo _JSHOP_CHANGE_ORDER_STATUS;?>', 0, '');">
     <?php }?>
