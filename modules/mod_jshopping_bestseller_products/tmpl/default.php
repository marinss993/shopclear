<div class="bestseller_products  jshop jshop_list_product">
...
<?php 		if ($product->buy_link && $show_button_buy){?>
            <a class="btn button_buy" href="<?php print $product->buy_link?>"><?php print _JSHOP_BUY?></a> &nbsp;
<?php 		}?>
<?php 		if ($show_button_detal){?>
            <a class="btn button_detail" href="<?php print $product->product_link?>"><?php print _JSHOP_DETAIL?></a>
<?php		}?>
